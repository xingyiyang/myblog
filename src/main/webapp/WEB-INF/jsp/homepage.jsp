...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="<%=basePath %>/img/homepage/0-big.jpg" alt="0 slide">
            <div class="container">
        ...
        <div class="item">
            <img src="<%=basePath %>/img/homepage/1-big.jpg" alt="1 slide">
            <div class="container">
                <div class="carousel-caption">
                    <h1>Firefox</h1>
        ...
        <div class="item">
            <img src="<%=basePath %>/img/homepage/2-big.jpg" alt="2 slide">
            <div class="container">
                <div class="carousel-caption">
                    <h1>Safari</h1>
        ...
        <div class="item">
            <img src="<%=basePath %>/img/homepage/3-big.jpg" alt="3 slide">
            <div class="container">
                <div class="carousel-caption">
                    <h1>Opera</h1>
        ...
        <div class="item">
            <img src="<%=basePath %>/img/homepage/4-big.jpg" alt="4 slide">
            <div class="container">
                <div class="carousel-caption">
                    <h1>IE</h1>
...
<div class="container summary">
    ...
    <div class="row" id="summary-container">
        <div class="col-md-4">
            <img class="img-circle" src="<%=basePath %>/img/homepage/chrome-logo-small.jpg" alt="chrome">
            <h2>Chrome</h2>
            <p>Google Chrome，又称Google浏览器，是一个由Google（谷歌）公司开发的网页浏览器。</p>
            <p><a class="btn btn-default" href="#" role="button">点我下载</a></p>
        </div>
        <div class="col-md-4">
            <img class="img-circle" src="<%=basePath %>/img/homepage/firefox-logo-small.jpg" alt="firefox">
            <h2>Firefox</h2>
            <p>Mozilla Firefox，中文名通常称为“火狐”或“火狐浏览器”，是一个开源网页浏览器。</p>
            <p><a class="btn btn-default" href="#" role="button">点我下载</a></p>
        </div>
        <div class="col-md-4">
            <img class="img-circle" src="<%=basePath %>/img/homepage/safari-logo-small.jpg" alt="safari">
            <h2>Safari</h2>
            <p>Safari，是苹果计算机的最新操作系统Mac OS X中的浏览器。</p>
            <p><a class="btn btn-default" href="#" role="button">点我下载</a></p>
        </div>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab-chrome">
                <div class="row feature">
                    ...
                    <div class="col-md-5">
                        <img class="feature-image img-responsive" src="<%=basePath %>/img/homepage/chrome-logo.jpg" alt="Chrome">
                    </div>
                </div>
            </div>
            <div role="tabpanel" class="tab-pane" id="tab-firefox">
                <div class="row feature">
                    <div class="col-md-5">
                        <img class="feature-image img-responsive" src="<%=basePath %>/img/homepage/firefox-logo.jpg" alt="Firefox">
                    </div>
                    <div class="col-md-7">
            ...
            <div role="tabpanel" class="tab-pane" id="tab-safari">
                <div class="row feature">
                    ...
                    <div class="col-md-5">
                        <img class="feature-image img-responsive" src="<%=basePath %>/img/homepage/safari-logo.jpg" alt="Safari">
                    </div>
                </div>
            </div>
            <div role="tabpanel" class="tab-pane" id="tab-opera">
                <div class="row feature">
                    <div class="col-md-5">
                        <img class="feature-image img-responsive" src="<%=basePath %>/img/homepage/opera-logo.jpg" alt="Opera">
                    </div>
                    <div class="col-md-7">
            ...
            <div role="tabpanel" class="tab-pane" id="tab-ie">
                <div class="row feature">
                    ...
                    <div class="col-md-5">
                        <img class="feature-image img-responsive" src="<%=basePath %>/img/homepage/ie-logo.jpg" alt="IE">
                    </div>
                </div>
            </div>
        </div>
